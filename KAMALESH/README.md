...
<body>
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-5">
        <img src="pharmacy 1.png" class="img-fluid" alt="Pharmacy Image" width="2000" height="2000">
      </div>
      <div class="col-md-4">
        <img src="medi.png" class="img-fluid" alt="Pharmacy Image" width="2000" height="2000">
      </div>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 PharmaCompany - DHINESH R (212223220019). All rights reserved.</p>
  </footer>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="kasthuri.png" class="card-img-top" alt="Product 1">
            <div class="card-body">
          ...
          <div class="card">
            <img src="pankaja.png" class="card-img-top" alt="Product 2">
            <div class="card-body">
          ...
          <div class="card">
            <img src="herbal.png" class="card-img-top" alt="Product 3">
            <div class="card-body">
...
### OUTPUT:
![alt text](<Screenshot 2024-05-13 193554.png>)
![alt text](<Screenshot 2024-05-13 192614.png>)
![alt text](<Screenshot 2024-05-13 193241.png>)
![alt text](<Screenshot 2024-05-13 193525.png>)
